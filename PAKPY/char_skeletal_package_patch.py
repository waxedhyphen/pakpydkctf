...
from skeletal_codec import write_char_blender_helper
    ...
    def export_char_package(parsed, entry, out_dir, require_store=None):
        ...
        def helper(package_dir, parsed_arg, model_entry, model_uuid, source, require_store_arg):
            ...
            try:
                ...
                result = export_model_package(model_parsed, model_entry, Path(package_dir) / 'model_packages', require_store=require_store_arg, animation_refs=animation_refs)
