...
from model_animation_refs_patch import install as install_model_animation_refs
from char_anim_selector_patch import install as install_char_anim_selector
from anim_raw_probe_patch import install as install_anim_raw_probe
from anim_track_skel_map_patch import install as install_anim_track_skel_map
from anim_timeline_summary_scope_patch import install as install_anim_timeline_summary_scope
from blender_named_timeline_patch import install as install_blender_named_timeline
from blender_preview_timeline_script_patch import install as install_blender_preview_timeline_script
from blender_normal_clip_action_script_patch import install as install_blender_normal_clip_action_script
from blender_embed_normal_clip_actions_patch import install as install_blender_embed_normal_clip_actions
from blender_embed_character_actions_patch import install as install_blender_embed_character_actions
from blender_normal_clip_fixed_basis_patch import install as install_blender_normal_clip_fixed_basis
from char_required_anim_mirror_patch import install as install_char_required_anim_mirror
from prefix_track_map_patch import install as install_prefix_track_map
from anim_normal_clip_indices_patch import install as install_anim_normal_clip_indices
from anim_normal_clip_setup_patch import install as install_anim_normal_clip_setup
from anim_normal_clip_frames_patch import install as install_anim_normal_clip_frames
from anim_normal_clip_values_patch import install as install_anim_normal_clip_values
from anim_normal_clip_pose_patch import install as install_anim_normal_clip_pose
from anim_normal_clip_bind_patch import install as install_anim_normal_clip_bind
from group_accept_patch import install as install_group_accept
...
install_model_animation_refs(App)
install_char_anim_selector(App)
install_anim_raw_probe(App)
install_prefix_track_map(App)
install_anim_normal_clip_indices(App)
install_anim_normal_clip_setup(App)
install_anim_normal_clip_frames(App)
install_anim_normal_clip_values(App)
install_anim_normal_clip_pose(App)
install_anim_normal_clip_bind(App)
install_anim_track_skel_map(App)
install_group_accept(App)
install_anim_timeline_summary_scope(App)
install_blender_named_timeline(App)
install_blender_preview_timeline_script(App)
install_blender_normal_clip_fixed_basis()
install_blender_normal_clip_action_script(App)
install_char_required_anim_mirror(App)
install_blender_embed_normal_clip_actions()
install_blender_embed_character_actions()
def main():
